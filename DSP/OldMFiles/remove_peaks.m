...
function y = remove_peaks(x, start_peak, end_peak, peak_rate, fs, search_window, filter_window)
%x = input data
...
while pos < end_peak+search_window
    ...
    y(center-filter_window:center+filter_window) = 0;
