...
if(isempty(obj.DataCommon.UTCref))
    ...
    str = sprintf('%s (%s UTC, Span = %6.3f - %6.3f sec)  %6.3f samps/sec', ...
                obj.DataCommon.title, datenum2str(obj.DataCommon.UTCref), obj.DataCommon.timeOffset, obj.DataCommon.timeEnd, obj.sampleRate);
end
