function shotAmplAngle( bldg, iLogger, incidentPulse, pulseType )
...
actualIncidents = find(incidentsIL~=-9999 &  anglesIL>0);
...
legend( { 'Blank', 'Pistol' } )
ylabel( ['Gunshot ', lbl ] )
xlabel('Angle off optical axis')
title( [ pTypTxt, ' Blank vs. Pistol Angle/Strength ', lbl, ' at: ', bldg ] )

plotName=[ bldg, '.', pTypTxt, '.', lbl, '.Angle.jpg' ];
